...
export default async function BlogPage(): Promise<JSX.Element> {
  ...
  return (
    <div className="bg-slate-50/60 dark:bg-slate-950">
      <section className="border-b border-slate-100 bg-white py-12 dark:border-slate-800 dark:bg-slate-900 sm:py-16">
      ...
      <section className="py-12 dark:bg-slate-950 sm:py-16">
        <div className="mx-auto max-w-page px-4 sm:px-6 lg:px-8">
          {posts.length === 0 ? (

...
export function QatarPhoneInput({
  ...
  return (
    <div
      className={cn(
        'flex overflow-hidden rounded-md border border-slate-200 focus-within:ring-2 focus-within:ring-brand-500',
    ...
    >
      ...
      <Input
        ...
        className={cn('h-11 border-0 focus-visible:ring-0', className)}
      />
    </div>
  );
}
